...
#include "Commands/AlignToWall.h"
...
OI::OI() {
    ...
    aButton.reset(new JoystickButton(joystick1.get(), 1));
    aButton->WhileHeld(new AlignToWall());
    rightBumper.reset(new JoystickButton(joystick1.get(), 5));
	rightBumper->WhileHeld(new ComboAlignToGear());
