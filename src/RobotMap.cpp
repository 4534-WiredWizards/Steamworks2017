...
std::shared_ptr<SerialPort> RobotMap::arduinoComm;
std::shared_ptr<DigitalInput> RobotMap::leftLimit;
std::shared_ptr<DigitalInput> RobotMap::rightLimit;
void RobotMap::init() {
    ...
    leftLimit.reset(new DigitalInput(0));
    rightLimit.reset(new DigitalInput(1));
