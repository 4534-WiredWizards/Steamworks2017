...
public:
	...
	static std::shared_ptr<SpeedController> shooterKicker;
	static std::shared_ptr<SpeedController> climberClimbMotor;
	static std::shared_ptr<SpeedController> intakeIntakeMotor;
	static std::shared_ptr<SpeedController> tempShooterSpinner;
